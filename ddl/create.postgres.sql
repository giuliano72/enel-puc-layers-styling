...
create table layer_rule (linked boolean, id bigint not null, environment varchar(255), layer_group varchar(255), value TEXT, primary key (id));
create table layer_rule_criteria (id bigint not null, criteria_type varchar(31) not null, criteria_operator varchar(255), field varchar(255), field_type varchar(255), operator varchar(255), rule_ref varchar(255), value varchar(255), primary key (id));
